...
const TicketToSupport = ({
  ...
  return (
    <div className={`${isTicketToSupport ? "block" : "hidden"} p-[20px] bg-additional-bg border-[3px] flex flex-col items-center justify-between  border-border-blocks absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] w-[30%] h-[50%] z-[10]`}>
